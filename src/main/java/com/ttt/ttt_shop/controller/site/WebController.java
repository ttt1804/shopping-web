...
public class WebController {
    ...
    public String home(Model model){
        List<Product> productsPhone = productService.getTop8ProductsByCategoryId(1L);
        List<Product> productsLaptop = productService.getTop8ProductsByCategoryId(2L);
        List<Product> productsTablet = productService.getTop8ProductsByCategoryId(3L);
        List<Product> productsWatch = productService.getTop8ProductsByCategoryId(4L);
